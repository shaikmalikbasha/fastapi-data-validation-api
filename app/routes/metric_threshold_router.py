...
from app.schemas.metric_threshold_schemas import CreateAndUpdateMetricThreshold
...
@metric_threshold_router.get("/", status_code=200)
...
@metric_threshold_router.get("/{threshold_id}", status_code=status.HTTP_200_OK)
